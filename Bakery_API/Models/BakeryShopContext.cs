...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=VanTran\\VANTRAN;Initial Catalog=bakeryShop;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Delivery>(entity =>
        {
            entity.HasKey(e => e.DeliveryId).HasName("PK__Deliveri__CDC3A0B2CA4AE876");
        ...
        {
            entity.HasKey(e => e.GroupProductId).HasName("PK__GroupPro__61C82376A4624C29");
        ...
        {
            entity.HasKey(e => e.MembershipId).HasName("PK__Membersh__86AA3B17B69FAD86");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__0809335DA5587D90");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__A0D9EFC68B3C1D78");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__2D10D16A9BEDACF7");
        ...
        {
            entity.HasKey(e => e.ProductCategoryId).HasName("PK__ProductC__A944253B8CFE92EC");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__2ECD6E04DD0C16DC");
        ...
        {
            entity.HasKey(e => e.ShoppingCartItemId).HasName("PK__Shopping__1CF034B4034685B6");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Statuses__36257A18F9DA7B6E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__CB9A1CFF95770124");

            entity.HasIndex(e => e.Gmail, "UQ__Users__493D0C0AED5CA6C5").IsUnique();
