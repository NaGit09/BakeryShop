...
public partial class BakeryShopContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=HDUC;Initial Catalog=bakeryShop;Persist Security Info=True;User ID=HoaiDuc;Password=hoaiduc2903;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Delivery>(entity =>
        {
            entity.HasKey(e => e.DeliveryId).HasName("PK__Deliveri__CDC3A0B2AD27ACDC");
        ...
        {
            entity.HasKey(e => e.GroupProductId).HasName("PK__GroupPro__61C823760BB0AAA6");
        ...
        {
            entity.HasKey(e => e.MembershipId).HasName("PK__Membersh__86AA3B17EB28EC05");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__0809335D671E8ABD");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__A0D9EFC654AE3505");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__2D10D16A479BD9C1");
        ...
        {
            entity.HasKey(e => e.ProductCategoryId).HasName("PK__ProductC__A944253B5EE8AB9A");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__2ECD6E049454DC39");
        ...
        {
            entity.HasKey(e => e.ShoppingCartItemId).HasName("PK__Shopping__1CF034B49D1FC79C");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Statuses__36257A188BEA3914");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__CB9A1CFF0AE57F9A");

            entity.HasIndex(e => e.Gmail, "UQ__Users__493D0C0A95DF752E").IsUnique();
